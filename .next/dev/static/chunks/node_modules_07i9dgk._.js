...
"[project]/node_modules/react-animated-cursor/dist/index.umd.js [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {

(function(global, factory) {
    ("TURBOPACK compile-time truthy", 1) ? module.exports = factory(__turbopack_context__.r("[project]/node_modules/next/dist/compiled/react/jsx-runtime.js [app-client] (ecmascript)"), __turbopack_context__.r("[project]/node_modules/next/dist/compiled/react/index.js [app-client] (ecmascript)")) : "TURBOPACK unreachable";
})(/*TURBOPACK member replacement*/ __turbopack_context__.e, function(jsxRuntime, react) {
    'use strict';
    /******************************************************************************
    ...
    ***************************************************************************** */ /* global Reflect, Promise */ var __assign = function() {
        ...
        react.useEffect({
            "useEventListener.useEffect": function() {
                ...
                var internalListener = {
                    "useEventListener.useEffect.internalListener": function(ev) {
                        return listenerRef.current(ev);
                    }
                }["useEventListener.useEffect.internalListener"];
    ...
    var useDeviceInfo = function() {
        var _a = react.useState({
            info: '',
            Android: {
                "useDeviceInfo.useState[_a]": function() {
                    return null;
                }
            }["useDeviceInfo.useState[_a]"],
            BlackBerry: {
                "useDeviceInfo.useState[_a]": function() {
                    return null;
                }
        ...
        react.useEffect({
            "useDeviceInfo.useEffect": function() {
                if (typeof navigator !== 'undefined') {
                    var ua_1 = navigator.userAgent;
                    setDeviceInfo({
                        "useDeviceInfo.useEffect": function(prevDeviceInfo) {
     ...
     */ function CursorCore(_a) {
        ...
        var defaultOptions = react.useMemo({
            "CursorCore.useMemo[defaultOptions]": function() {
                return {
                    children: children,
                    color: color,
        ...
        }["CursorCore.useMemo[defaultOptions]"], [
            children,
            color,
            innerScale,
            innerSize,
         ...
         */ var onMouseMove = react.useCallback({
            "CursorCore.useCallback[onMouseMove]": function(event) {
        ...
        }["CursorCore.useCallback[onMouseMove]"], []);
        // Outer Cursor Animation Delay
        var animateOuterCursor = react.useCallback({
            "CursorCore.useCallback[animateOuterCursor]": function(time) {
        ...
        }["CursorCore.useCallback[animateOuterCursor]"], [
            requestRef
        ] // eslint-disable-line
        );
        // Outer cursor RAF setup / cleanup
        react.useEffect({
            "CursorCore.useEffect": function() {
                requestRef.current = requestAnimationFrame(animateOuterCursor);
                return ({
                    "CursorCore.useEffect": function() {
        ...
        var scaleBySize = react.useCallback({
            "CursorCore.useCallback[scaleBySize]": function(cursorRef, orignalSize, scaleAmount) {
                if (cursorRef) {
        ...
        }["CursorCore.useCallback[scaleBySize]"], []);
        // Mouse Events State updates
        var onMouseDown = react.useCallback({
            "CursorCore.useCallback[onMouseDown]": function() {
                return setIsActive(true);
            }
        }["CursorCore.useCallback[onMouseDown]"], []);
        var onMouseUp = react.useCallback({
            "CursorCore.useCallback[onMouseUp]": function() {
                return setIsActive(false);
            }
        }["CursorCore.useCallback[onMouseUp]"], []);
        var onMouseEnterViewport = react.useCallback({
            "CursorCore.useCallback[onMouseEnterViewport]": function() {
                return setIsVisible(true);
            }
        }["CursorCore.useCallback[onMouseEnterViewport]"], []);
        var onMouseLeaveViewport = react.useCallback({
            "CursorCore.useCallback[onMouseLeaveViewport]": function() {
                return setIsVisible(false);
            }
        }["CursorCore.useCallback[onMouseLeaveViewport]"], []);
        ...
        react.useEffect({
            "CursorCore.useEffect": function() {
                var clickableEls = document.querySelectorAll(clickables.map({
                    "CursorCore.useEffect.clickableEls": function(clickable) {
                ...
                }["CursorCore.useEffect.clickableEls"]).join(','));
                clickableEls.forEach({
                    "CursorCore.useEffect": function(el) {
                        if (!showSystemCursor) el.style.cursor = 'none';
                        var clickableOptions = typeof clickables === 'object' ? findInArray(clickables, {
                            "CursorCore.useEffect": function(clickable) {
...
//# sourceMappingURL=node_modules_07i9dgk._.js.map